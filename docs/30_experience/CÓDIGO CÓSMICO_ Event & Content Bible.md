...
No define reglas numéricas de balance ni fórmulas de simulación. Esas viven en `docs/20_systems/CÓDIGO CÓSMICO_ System Balance Sheet.md`.
...
Esto evita duplicar la definición de loops, ya detallada en `docs/10_product/CÓDIGO CÓSMICO_ Core Loops.md`.
...
Referencia: `docs/30_experience/CÓDIGO CÓSMICO_ Localization Spec.md`.
