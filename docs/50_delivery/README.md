...
Esta carpeta convierte la documentacion en ejecucion: readiness, riesgos, estado real, fases, gates y backlog priorizado.

## Resumen rapido

- Control de avance por fases (sin calendario fijo).
- Priorizacion operativa para equipo pequeno (2-3 personas).
