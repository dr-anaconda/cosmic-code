...
- `docs/90_archive/init/GDD_ CÓDIGO CÓSMICO – EVOLUCIÓN PROFUNDA.md` (fuente primaria)
- `docs/10_product/CÓDIGO CÓSMICO_ PRD.md` (visión de producto)
...
- `docs/20_systems/CÓDIGO CÓSMICO_ System Balance Sheet.md` (números, fórmulas)
- `docs/20_systems/CÓDIGO CÓSMICO_ Data Dictionary.md` (entidades, campos)
- `docs/30_experience/CÓDIGO CÓSMICO_ UI_UX.md` (interfaces)
- `docs/40_technical/CÓDIGO CÓSMICO_ ADD.md` (arquitectura)
- `docs/40_technical/CÓDIGO CÓSMICO_ Tournament System.md` (ligas y competencia)
- `docs/40_technical/CÓDIGO CÓSMICO_ Monetization Spec.md` (tienda, tokens)
...
> **Referencia:** Multijugador completo en `docs/40_technical/CÓDIGO CÓSMICO_ Multiplayer Spec.md`
...
> **Referencia:** Detalles en `docs/40_technical/CÓDIGO CÓSMICO_ Monetization Spec.md`
...
| Documento | Relación |
|-----------|----------|
| `docs/90_archive/init/GDD_ CÓDIGO CÓSMICO – EVOLUCIÓN PROFUNDA.md` | Fuente primaria - no redundar, referenciar |
| `docs/10_product/CÓDIGO CÓSMICO_ PRD.md` | Visión de producto - coherencia con objetivos |
| `docs/10_product/CÓDIGO CÓSMICO_ Core Loops.md` | Detalle de bucles de juego |
| `docs/20_systems/CÓDIGO CÓSMICO_ System Balance Sheet.md` | Fórmulas y números (no aquí) |
| `docs/20_systems/CÓDIGO CÓSMICO_ Data Dictionary.md` | Entidades y campos (no aquí) |
| `docs/30_experience/CÓDIGO CÓSMICO_ UI_UX.md` | Especificación de interfaces (no aquí) |
| `docs/40_technical/CÓDIGO CÓSMICO_ ADD.md` | Arquitectura técnica (no aquí) |
| `docs/40_technical/CÓDIGO CÓSMICO_ Tournament System.md` | Sistema competitivo semanal (no aquí) |
| `docs/30_experience/CÓDIGO CÓSMICO_ Event & Content Bible.md` | Taxonomía y operación de contenido (no aquí) |
| `docs/30_experience/CÓDIGO CÓSMICO_ Localization Spec.md` | Internacionalización y glosario (no aquí) |
